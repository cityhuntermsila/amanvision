      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="text-center mb-8 lg:mb-12 space-y-3 lg:space-y-4">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tighter text-[#601344] leading-none">
            La sérénité <span className="text-[#0077C8]">sans compromis</span>.
          </h1>
          <p className="text-lg lg:text-xl text-slate-500 max-w-2xl mx-auto font-medium leading-relaxed px-4">
            Choisissez le forfait qui correspond à votre besoin de protection.
          </p>
        </div>
            ...
            >
              ...
              <div className="mb-4 lg:mb-6">
                ...
                <div className="flex items-baseline gap-1.5">
                  ...
                  <span className="text-slate-400 font-bold uppercase text-[7px] lg:text-[8px] tracking-widest">/mois</span>
                </div>
              ...
              >
                {currentPlan === plan.plan && plan.plan === 'free' ? 'Plan Actif' : plan.buttonText}
              </button>
            </div>
          ))}
        </div>
        ...
        <div className="mt-10 lg:mt-12 p-6 lg:p-10 bg-[#601344] rounded-[2rem] lg:rounded-[3rem] text-white flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 shadow-2xl relative overflow-hidden text-center lg:text-left">
          <div className="space-y-2 lg:space-y-3 relative z-10 lg:w-2/3">
            <h3 className="text-2xl lg:text-4xl font-extrabold tracking-tighter leading-none">Solutions <span className="text-rose-300">Entreprise</span>.</h3>
            <p className="text-rose-100/60 font-medium text-sm lg:text-base leading-relaxed">Audit sécurité personnalisé pour hôpitaux et industries.</p>
          </div>
          <button
