...
const Home: React.FC<HomeProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="animate-in fade-in duration-1000">
      {/* Hero Section */}
      <section className="relative pt-24 pb-32 lg:pt-40 lg:pb-48 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:gap-16">
            <div className="lg:w-1/2 space-y-10 text-left">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-rose-50 rounded-full border border-rose-100 text-[#601344] text-[10px] font-black uppercase tracking-widest">
                  <ShieldAlert className="w-4 h-4" />
                  Protection Intelligente v4.0
                </div>
                <h1 className="text-5xl lg:text-8xl font-extrabold tracking-tighter text-[#601344] leading-[0.9]">
                  AmanVision
                </h1>
                <p className="text-xl lg:text-3xl font-bold text-[#0077C8] italic tracking-tight leading-snug">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <button
                  ...
                  className="px-10 py-5 bg-[#0077C8] text-white rounded-full font-extrabold text-lg hover:bg-[#601344] transition-all flex items-center justify-center gap-3 shadow-xl active:scale-95"
                >
                  Dès 1000 DZD / mois
                ...
                <button
                  ...
                  className="px-10 py-5 bg-white border-2 border-[#601344] text-[#601344] rounded-full font-extrabold text-lg hover:bg-rose-50 transition-all flex items-center justify-center gap-3 active:scale-95"
                >
                  Démo IA Live
                </button>
              </div>
      ...
      <section className="py-24 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 lg:mb-20 space-y-6">
            <h2 className="text-[#601344] text-4xl lg:text-6xl font-extrabold tracking-tighter leading-none">
              Un Seul Cœur IA, <br /><span className="text-[#0077C8]">Toutes les Chutes Détectées</span>.
            </h2>
            <p className="text-lg lg:text-xl text-slate-500 font-medium max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {sectors.map((sector, idx) => (
              <div key={idx} className="group bg-white rounded-[3rem] overflow-hidden shadow-medical border border-slate-100 transition-all hover:shadow-2xl mx-auto w-full max-w-sm lg:max-w-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:gap-20">
            <div className="lg:w-1/2 space-y-10 text-center lg:text-left">
              <h2 className="text-[#601344] text-4xl lg:text-6xl font-extrabold tracking-tighter leading-tight">
              ...
              <div className="grid grid-cols-2 gap-4 lg:gap-6 pb-4">
                <div className="p-6 lg:p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                  <div className="text-3xl lg:text-4xl font-black text-[#601344]">0.8s</div>
                  <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2">Délai d'Alerte</div>
                </div>
                <div className="p-6 lg:p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                  <div className="text-3xl lg:text-4xl font-black text-[#0077C8]">100%</div>
                  <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2">Précision</div>
                </div>
              </div>
            </div>

            <div className="lg:w-1/2 mt-12 lg:mt-0 flex justify-center">
              <div className="relative rounded-[4rem] overflow-hidden shadow-2xl border-8 border-slate-50 aspect-square lg:aspect-video w-full max-w-lg lg:max-w-none bg-slate-100 flex items-center justify-center">
                <img
        ...
        <div className="max-w-7xl mx-auto px-4 text-center space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-10 lg:p-12 rounded-[3.5rem] shadow-medical space-y-6 border border-white hover:border-rose-100 transition-all mx-auto w-full max-w-sm lg:max-w-none">
